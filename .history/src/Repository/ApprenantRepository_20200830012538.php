...
class ApprenantRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function findOneBySomeField($id_apprenant,$id_promotion): ?Apprenant
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.id = :id_apprenant')
            ->andWhere('a.promotion = :id_promotion')
    ...
    public function findOneByIdUser($id_user): ?Apprenant
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.user = :id_user')
            ->setParameter('id_promotion', $id_user)
            ->getQuery()
            ->getOneOrNullResult()
        ;
    }
