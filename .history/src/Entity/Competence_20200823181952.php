...
class Competence
{
     ...
     * @Groups({@Groups({"apprenant_competence:read"})"brief_livrable_partiel:read","brief:read","grpcompetence:read","grpcompetence:read_all","competence:read_all","referentiel:read_all","promotion:read_all_ref"})
     */
    private $id;
