...
class GroupeCompetence
{
     ...
     * @Groups({"grpcompetence:read","grpcompetence:read_all","promotion:read_all_ref","referentiel:read","referentiel:read_all","grpcompetence:write","competence:write"})
     */
    private $libelle;

    /**
     * @ORM\Column(type="text", nullable=true)
     * @Groups({"grpcompetence:read","grpcompetence:read_all","promotion:read_all_ref","referentiel:read","referentiel:read_all","grpcompetence:write"})
