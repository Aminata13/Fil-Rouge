 ...
 *         "method"="PUT",
 *         "path"="/formateurs/promotion/id/brief/id/livrablepartiels",
 *         "controller"=LivrablePartielController::class,
 *         "access_control"="(is_granted('ROLE_FORMATEUR') or is_granted('ROLE_ADMIN'))",
...
class LivrablePartiel
{
     ...
     * @Groups({"brief_livrable_partiel:read","livrable:write"})
     */
    private $libelle;
    ...
    /**
     * @ORM\OneToMany(targetEntity=LivrableRendu::class, mappedBy="livrablePartiel", cascade={"persist"})
     */
    private $livrableRendus;

    /**
     * @ORM\ManyToOne(targetEntity=BriefPromotion::class, inversedBy="livrablePartiel", cascade={"persist"})
