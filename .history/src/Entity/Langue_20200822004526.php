...
class Langue
{
     ...
     * @Groups({"bref:read","groupe:read","promo_groupe_apprenants:read","promotion:read","promotion:read_all","promotion:read_all_ref"})
     */
    private $id;
     ...
     * @Groups({"brief:read","groupe:read","promo_groupe_apprenants:read","promotion:read","promotion:read_all","promotion:read_all_ref"})
     */
    private $libelle;
