...
class Competence
{
     ...
     * @Groups({"grpcompetence:read","grpcompetence:read_all","competence:read_all","referentiel:read_all","grpcompetence:write","grpcompetence:edit", "competence:write"})
     * @Assert\NotBlank(message="le libelle d'une huile competence est requis.")
     */
    private $libelle;
