 ...
 * @UniqueEntity(
 * fields={"libelle"},
 * message="Le libelle des fabriques doit être unique."
 * )
 * @ApiResource()
 */
class Fabrique
{
     ...
     * @Groups({"briefGroupe:read","groupe:read","promo_groupe_apprenants:read","promotion:read","promotion:read_all","promotion:read_all_ref"})
     */
    private $id;
