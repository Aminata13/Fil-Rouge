...
class Referentiel
{
     ...
     * @Groups({"brief:read","brief_livrable_partiel:read","briefGroupe:read","groupe:read","promo_groupe_apprenants:read","referentiel:read","referentiel:read_all","promotion:read_all","promotion:read_all_ref"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"brief:read","brief_livrable_partiel:read","briefGroupe:read","promotion:read","groupe:read","referentiel:write","promo_groupe_apprenants:read","referentiel:read","referentiel:read_all","promotion:read_all","promotion:read_all_ref"})
     ...
     * @Groups({"brief:read""brief_livrable_partiel:read","briefGroupe:read","promotion:read","groupe:read","promo_groupe_apprenants:read","referentiel:read","referentiel:read_all","promotion:read_all","promotion:read_all_ref"})
     */
     ...
     * @Groups({"referentiel:read","referentiel:write","promo_groupe_apprenants:read","promotion:read_all_ref"})
     */
    private $programme;
