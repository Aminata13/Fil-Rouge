...
class Competence
{
     ...
     * @Groups({"brief:re","grpcompetence:read","grpcompetence:read_all","competence:read_all","referentiel:read_all","promotion:read_all_ref"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"grpcompetence:read","grpcompetence:read_all","competence:read_all","referentiel:read_all","grpcompetence:write", "competence:write","promotion:read_all_ref"})
     ...
     * @Groups({"grpcompetence:read_all","competence:read_all", "competence:write","promotion:read_all_ref"})
     */
    private $niveaux;
