 ...
 *         "controller"=EditGroupeCompetence::class,
 *         "access_control"="(is_granted('ROLE_ADMIN'))",
 *         "route_name"="edit_groupe_competence",
 *         "denormalization_context"={"groups"={"grpcompetence:edit"}}
 *     }
 *  }
 * )
...
class GroupeCompetence
{
     ...
     * @Groups({"grpcompetence:read","grpcompetence:read_all","referentiel:read","referentiel:read_all","grpcompetence:write","grpcompetence:edit","competence:write"})
     */
    private $libelle;

    /**
     * @ORM\Column(type="text", nullable=true)
     * @Groups({"grpcompetence:read","grpcompetence:read_all","referentiel:read","referentiel:read_all","grpcompetence:write","grpcompetence:edit"})
     ...
     * @Groups({"grpcompetence:read","grpcompetence:read_all","referentiel:read_all","grpcompetence:write","grpcompetence:edit"})
     */
    private $competences;
