...
class Competence
{
     ...
     * @Groups({"brief:read","grpcompetence:read","grpcompetence:read_all","competence:read_all","referentiel:read_all","grpcompetence:write", "competence:write","promotion:read_all_ref"})
