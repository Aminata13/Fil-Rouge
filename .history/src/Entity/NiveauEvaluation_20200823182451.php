...
class NiveauEvaluation
{
     ...
     * @Groups({"apprenant_competence:read","brief_livrable_partiel:read","briefGroupe:read","brief:read","grpcompetence:read_all","competence:read_all","promotion:read_all_ref"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"apprenant_competence:read""brief_livrable_partiel:read","briefGroupe:read","brief:read","grpcompetence:read_all","competence:read_all","competence:write","promotion:read_all_ref"})
     */
    private $libelle;
