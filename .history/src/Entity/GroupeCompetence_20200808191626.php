 ...
 * )
 * @ApiResource(
 *  attributes={ "input_formats"={"json"={"application/ld+json"}}, "output_formats"={"json"={"application/ld+json"}},
 *  
...
class GroupeCompetence
{
     ...
     * @Groups({"grpcompetence:read","grpcompetence:read_all","referentiel:read","referentiel:read_all","grpcompetence:write","competence:write"})
     */
    private $libelle;
