...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function showStatistiquesByCompetences(SerializerInterface $serializer, int $id_promo, int $id_ref, CompetenceValideRepository $repoComptenceValide)
    {
        $competenceValide = $repoComptenceValide->findOneBySomeField($id_promo,$id)
    }
