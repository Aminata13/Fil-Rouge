...
class EditPromotionReferentielsController extends AbstractController
{
    ...
    */
    public function editPromotionRef( int $id,PromotionRepository $repoPromotion,ReferentielRepository $reporef,LangueRepository $repoLangue,FabriqueRepository $repoFabrique,SerializerInterface $serializer,Request $request,
