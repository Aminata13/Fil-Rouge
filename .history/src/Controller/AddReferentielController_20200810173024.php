...
class AddReferentielController extends AbstractController
{
     ...
     * )
     */
    public function addReferentiel(Valida,Request $request, EntityManagerInterface $em, SerializerInterface $serializer, GroupeCompetenceRepository $repoGroupeComp)
    {
