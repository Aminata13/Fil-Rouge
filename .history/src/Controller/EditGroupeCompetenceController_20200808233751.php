...
class EditGroupeCompetenceController extends AbstractController
{
     ...
     * )
     */
    public function editGroupeCompetence(int $id ,C,GroupeCompetenceRepository $repo, SerializerInterface $serializer, EntityManagerInterface $em, ValidatorInterface $validator,Request $request)
    {
