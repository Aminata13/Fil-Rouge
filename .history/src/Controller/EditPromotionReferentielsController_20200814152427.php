...
class EditPromotionReferentielsController extends AbstractController
{
     ...
     */
    public function editPromotionApprenats(ValidatorInterface $validator, int $id, UserProfilRepository $repoProfil, PromotionRepository $repoPromotion, StatutRepository $repoStatus, Request $request, EntityManagerInterface $em, UserPasswordEncoderInterface $encoder, \Swift_Mailer $mailer)
    {
