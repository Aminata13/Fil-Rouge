...
class UserController extends AbstractController
{
     ...
     */
    public function updateInfoapprenant(EntityManager $em,SerializerInterface $serializer,ApprenantRepository $repoApre)
    {
        // $user = $this->getUser();
        // $aprenant = $repoApre->findOneByIdUser($user->getId());
        // if (!$aprenant){
        ...
        // $em->persist($aprenant);
        // $em->flush();
        $userJson = $serializer->serialize(["attente"=>"oki bien vu","user"=>$user], 'json');

        return new JsonResponse("secces", Response::HTTP_OK, [], true);
    }
}
