...
class AddGroupeController extends AbstractController
{
    ...
    public function __construct(PromotionRepository $repoPromo,FormateurRepository $repoFormateur,appre,GroupeRepository $repo, EntityManagerInterface $em, ValidatorInterface $validator)
    {
        $this->em = $em;
        $this->repo = $repo;
