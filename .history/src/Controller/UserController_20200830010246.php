...
class UserController extends AbstractController
{
     ...
     */
    public function getUserConnecter(SerializerInterface $serializer)
    {
        $user = $this->getUser();
        $briefJson = $serializer->serialize($user, 'json', ["groups" => ["briefGroupe:read"]]);
        return new JsonResponse('OKI', Response::HTTP_OK, [], true);
    }
