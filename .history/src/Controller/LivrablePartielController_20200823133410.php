...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function showCommentairesByLivrablePartiel(SerializerInterface $serializer, int $id, LivrablePartielRepository $repoLivrablePartiels)
    {
        ...
        $commentaireJson = $serializer->serialize($commentaires, 'json', ["groups" => ["brief_livrable_partiel:read"]]);
