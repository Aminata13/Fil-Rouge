...
class EditCompetenceController extends AbstractController
{
     ...
     * )
     */
    public function editGroupeCompetence(int $id ,NiveauEvaluationRepository $repoNiveau,Com,GroupeCompetenceRepository $repoGroupCompe, SerializerInterface $serializer, EntityManagerInterface $em, ValidatorInterface $validator,Request $request)
    {
