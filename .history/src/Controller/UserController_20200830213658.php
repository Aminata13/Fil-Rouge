...
class UserController extends AbstractController
{
     ...
     */
    public function updateInfoapprenant(UserPasswordEncoderInterface $encoderEntityManagerInterface $em, SerializerInterface $serializer,Request $request,ApprenantRepository $repoApre)
    {
        $user = $this->getUser();
        $aprenant = $repoApre->findOneByIdUser($user->getId());
        if (!$aprenant){
