...
class EditGroupeCompetenceController extends AbstractController
{
     ...
     * )
     */
    public function editGroupeCompetence(GroupeCompetenceRepository $repo, SerializerInterface $serializer, EntityManagerInterface $em, ValidatorInterface $validator,Request $request)
    {
        dd($request->getParameters);

        $data=json_decode($request->getContent(),true);
        $groupeCompetence = $repo->findBy(array('libelle' => $data['libelle']));
