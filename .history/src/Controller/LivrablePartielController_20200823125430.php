...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function  putStatutByApprenant(Request $request, int $id_apprenant, int $id_livrable, StatutLivrableRepository $repo, ApprenantRepository $repoApprenant, LivrablePartielRepository $repoLivrablePartiels)
    {
