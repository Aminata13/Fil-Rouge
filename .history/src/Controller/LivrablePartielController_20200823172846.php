...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function  putLivrablePartielByFormateur(SerializerInterface $serializer, int $id_promo, int $id_brief, Request $request, EntityManagerInterface $em,Statutli,ApprenantRepository $repoApprenant , NiveauEvaluationRepository $repoNiveau, PromotionRepository $repoPromo, BriefRepository $repoBrief, LivrablePartielRepository $repoLivrablePartiels)
    {
        ...
        foreach ($apprenants as  $value) {
            ...
            if ($apprenant) {
                ...
                $livrableRendu->setStatut('ASSIGNER');
            }
        }
