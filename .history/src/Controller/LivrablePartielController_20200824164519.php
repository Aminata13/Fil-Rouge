...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function showStatistiquesByApprenantId(int $id_apprenant, int $id_promo, int $id_ref, ApprenantRepository $repoApprenant)
    {
        $apprenant = $repoApprenant->findOneBy($id_apprenant,$id_promo)
    }
