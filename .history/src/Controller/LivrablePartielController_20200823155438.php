...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function  putLivrablePartielByFormateur(int $id_promo, int $id_brief, Request $request, EntityManagerInterface $em, PromotionRepository $repoPromo, BriefRepository $repoBrief)
    {
        ...
        if(isset($data['deleted']) && $data['deleted']) {
            if (isset($data['id']) && $data['id']) {
               $livrablePartiel = $repoLivrablePartiels->find($data)
            }
