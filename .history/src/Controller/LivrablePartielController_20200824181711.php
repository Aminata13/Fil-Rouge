...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function showStatistiquesByCompetences(SerializerInterface $serializer, int $id_promo, int $id_ref, PromotionRepository $repoPromo, CompetenceValideRepository $repoComptenceValide)
    {
        $promo = $repoPromo->find
