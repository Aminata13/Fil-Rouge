...
class EditGroupeCompetenceController extends AbstractController
{
     ...
     * )
     */
    public function editGroupeCompetence(int $id ,CompetenceRepository $repoCope,GroupeCompetenceRepository $repo, SerializerInterface $serializer, EntityManagerInterface $em, ValidatorInterface $validator,Request $request)
    {
