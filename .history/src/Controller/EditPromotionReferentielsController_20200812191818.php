...
class EditPromotionReferentielsController extends AbstractController
{
    ...
    */
    public function editPromotionRef( int $id,PromotionRepository $repoPromotion,ReferentielRepository $reporef,LangueRepository $repoLangue,FabriqueRepository $repoFabrique,SerializerInterface $serializer,Request $request,EntityManagerInterface $em)
    {
    ...
    */
    public function editPromotionFormateurs(int $id,PromotionRepository $repoPromotion,FormateurRepository $repoFormateur,Request $request,EntityManagerInterface $em){

        $formateursExistante = $repoPromotion->find($id)->getFormateurs()
