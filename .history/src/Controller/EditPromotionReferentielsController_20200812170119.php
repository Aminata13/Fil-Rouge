...
class EditPromotionReferentielsController extends AbstractController
{
    ...
    */
     ...
     */
    public function editPromotionApprenats(int $id,PromotionRepository $repoPromotion,StatutRepository $repoStatus,Request $request,EntityManagerInterface $em,UserPasswordEncoderInterface $encoder,
        \Swift_Mailer $mailer
    ){
        $editPromotion = $repoPromotion->find($id);
