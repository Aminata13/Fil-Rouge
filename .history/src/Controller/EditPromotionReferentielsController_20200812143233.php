...
class EditPromotionReferentielsController extends AbstractController
{
    ...
    )
    {
        ...
        $editPromotion->setDescription($promotion->getDsetDescription());
        $editPromotion->setLieu($promotion->getLsetLieu());
        $editPromotion->setReferenceAgate($promotion->getTitre());
