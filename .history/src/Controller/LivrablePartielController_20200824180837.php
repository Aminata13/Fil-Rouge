...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function showStatistiquesByCompetences(SerializerInterface $serializer, int $id_apprenant, int $id_promo, int $id_ref, CompetenceValideRepository $repoComptence)
    {
    }
