...
{
    /**
     * @Route("/admin/promotion", name="relance_groupes", methods="POST")
     */
    ...
    /**
     * @Route("/admin/promotion/{id_promo}/relanceOne/{id_apprenant}", name="add_promotion", methods="POST")
     */
    public function relanceAll(){

    }

    /**
     * @Route("/admin/promotion/{id_promo}/relanceAll", name="add_promotion", methods="POST")
     */
    public function relanceOne(){
