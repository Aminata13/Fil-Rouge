...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function  putStatutByApprenant(RE, int $id_apprenant, int $id_livrable, ApprenantRepository $repoApprenant, LivrablePartielRepository $repoLivrablePartiels)
    {
