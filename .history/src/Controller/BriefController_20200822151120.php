...
class BriefController extends AbstractController
{
    ...
    /**
     * @Route("/formateurs/promotions/{id_promo}/groupe/{id_brief}/briefs", name="show_brief_by_promoId_by_groupe_id", methods="GET")
     */
    public function getBriefByPromo(SerializerInterface $serializer, int $id_promo, int $id_brief,PromotionRepository $repoPromo, BriefRepository $repoBrief, GroupeRepository $ripoGroupe){
        ...
        $groupe = $ripoGroupe->find($id_brief);
        if (empty($groupe) || !$promo->getGroupes()->contains($groupe)) {
            return new JsonResponse("Ce groupe n'existe pas.", Response::HTTP_NOT_FOUND, [], true);
        }
