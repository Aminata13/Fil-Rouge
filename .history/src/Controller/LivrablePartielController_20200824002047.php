...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function  putLivrablePartielByFormateur(\Swift_Mailer $mailer, SerializerInterface $serializer, int $id_promo, int $id_brief, Request $request, EntityManagerInterface $em, GroupeRepository $repoG, StatutLivrableRepository $repoStatut, ApprenantRepository $repoApprenant, NiveauEvaluationRepository $repoNiveau, PromotionRepository $repoPromo, BriefRepository $repoBrief, LivrablePartielRepository $repoLivrablePartiels)
    {
        ...
        foreach ($apprenants as  $value) {
            ...
            if ($apprenant) {
                ...
                $livrablePartiel->setDelai($data['dateSoumission']);
