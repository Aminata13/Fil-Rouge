...
class AddGroupeController extends AbstractController
{
    ...
    public function __construct(PromotionRepository $repoPromo,FormateurRepository $repoFormateur,ApprenantRepository $re,GroupeRepository $repo, EntityManagerInterface $em, ValidatorInterface $validator)
    {
        $this->em = $em;
        $this->repo = $repo;
