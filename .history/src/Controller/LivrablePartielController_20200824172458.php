...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function showStatistiquesByApprenantId(int $id_apprenant, int $id_promo, int $id_ref, ApprenantRepository $repoApprenant,BriefApprenantRepository $repoBriefApprenant , ReferentielRepository $repoReferentiel)
    {
        ...
        foreach ($briefPromotions as $value) {
            $briefApprenant= $repoBriefApprenant->findOneBySomeField($value->getId(),$id);
        }
