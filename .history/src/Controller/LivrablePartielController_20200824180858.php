...
class LivrablePartielController extends AbstractController
{
    ...
    /**
     * @Route("/formateurs/promo/{id_promo}/referentiel/id/statistiques/competences", name="show_statistiques_by_competences")
     */
    public function showStatistiquesByCompetences(SerializerInterface $serializer, int $id_promo, int $id_ref, CompetenceValideRepository $repoComptence)
    {
    }
