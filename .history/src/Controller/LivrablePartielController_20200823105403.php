...
class LivrablePartielController extends AbstractController
{
    ...
    /**
     * @Route("/formateurs/livrablepartiels/id/commentaires", name="show_commentaires_by_livrablePartiel")
     */
    public function show_commentaires_by_livrablePartiel()
    {
       
    }

    /**
     * @Route("/formateurs/livrablepartiels/id/commentaires", name="post_commentaire_by_formateur")
     */
