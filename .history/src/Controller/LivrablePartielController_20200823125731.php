...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function  putStatutByApprenant(Request $request, Ent, int $id_apprenant, int $id_livrable, StatutLivrableRepository $repoStatut, ApprenantRepository $repoApprenant, LivrablePartielRepository $repoLivrablePartiels)
    {
