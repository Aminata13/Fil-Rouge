...
class LivrablePartielController extends AbstractController
{
     ...
     */
    public function  putLivrablePartielByFormateur(int $id_promo, int $id_briefRequest $request, EntityManagerInterface $em, PromotionRepository $repoPromo, BriefRepository $repoBrief)
    {
