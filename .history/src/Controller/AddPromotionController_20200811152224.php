...
class AddPromotionController extends AbstractController
{
     ...
     */
    public function addUser(LangueRepository $repoLangue,FabriqueRepository $repo,SerializerInterface $serializer, Request $request, ValidatorInterface $validator, EntityManagerInterface $em, UserProfilRepository $repo, UserPasswordEncoderInterface $encoder)
    {
        ...
        $promotion->setFabrique($repoLangue->findBy(array('libelle' => $promotionTab['fabrique']))[0]);
