...
class AddCompetence
{
    ...
    public function __invoke(Competence $data)
    {
        ...
        if (empty($groupeCompetence)) {
            return new JsonResponse("Veuillez rattacher la competence à un groupe de competence.", Response::HTTP_BAD_REQUEST, [], true);
        }
        ...
        $competence->addGroupeCompetence($this->repo->findBy(array('libelle' => $groupeCompetence))[0]);
