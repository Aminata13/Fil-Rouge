...
class CritereAdmission
{
     ...
     * @Groups({"brief_livrable_partiel:read","brief:read","briefGroupe:read","groupe:read","promo_groupe_apprenants:read","critereAdmission:read","referentiel:read","referentiel:read_all","promotion:read","promotion:read_all","promotion:read_all_ref"})
     */
    private $id;
